// file: app/(embed)/embed/id/[id]/page.tsx
"use client";
    ...
    const fetchAllData = async () => {
      try {
        const [configRes, videoRes] = await Promise.all([
          fetch('/config.json'),
          // INI PERUBAHAN UTAMANYA: Menggunakan parameter 'ids' bukan 'wd'
          fetch(`https://avdbapi.com/api.php/provide/vod/?ac=detail&ids=${javId}`)
        ]);
